// <copyright file="HostSpecUnitTest.cs" company="Paul Mattes">
...
namespace Wx3270
{
    ...
    /// <summary>
    /// Unit tests for the <see cref="B3270HostSpec"/> class.
    /// </summary>
    [TestClass]
    public class HostSpecUnitTest
    {
        /// <summary>
        /// Tests simple host name parsing.
        /// </summary>
        [TestMethod]
        public void HostSpecTest()
        {
            var expected = new[]
            {
                // Basic unquoted.
            ...
            {
                var result = B3270HostSpec.TryParse(e.Item1, out List<char> prefixes, out List<string> lus, out string host, out string port, out string accept);
