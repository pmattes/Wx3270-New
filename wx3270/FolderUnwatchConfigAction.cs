// <copyright file="FolderUnwatchConfigAction.cs" company="Paul Mattes">
...
namespace Wx3270
{
    ...
    {
        /// <summary>
        /// Class for undoing and redoing a folder un-watch.
        /// </summary>
        private class FolderUnwatchConfigAction : ConfigAction
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="FolderUnwatchConfigAction"/> class.
            /// </summary>
            ...
            public FolderUnwatchConfigAction(string what, string dirName, IProfileTracker profileTracker, IProfileManager profileManager)
                : base(what)
            {
            ...
            /// <summary>
            /// Undo or redo a folder un-watch.
            /// </summary>
            ...
            public override void Apply(Stack<ConfigAction> from, Stack<ConfigAction> to, bool skipInvert)
            {
                ...
                var op = (FolderUnwatchConfigAction)from.Pop();
                if (op.IsUndo)
                {
                    // Reverse the operation: Start watching the folder again.
                    this.ProfileManager.Refocus(ProfileTree.DirNodeName(this.DirName));
                    this.ProfileTracker.Watch(op.DirName);
                }
                else
                {
                    // Re-do the operation: Stop watching the folder.
                    ...
                    {
                        ErrorBox.Show(I18n.Get(Message.CannotStopWatching), I18n.Get(Title.StopWatchingFolder));
                        return;
                    }
                ...
                if (!skipInvert)
                {
                    to.Push(new FolderUnwatchConfigAction(
                        this.What,
                        op.DirName,
                        this.ProfileTracker,
                        this.ProfileManager)
